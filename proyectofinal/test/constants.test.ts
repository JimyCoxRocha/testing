...
describe('CDM-2680: Constants Tests', () => {
  describe('Constants Enum', () => {
    ...
    it('should have all required error messages', () => {
      expect(Constants.MSG_ERROR_USUARIO_GENERAL).toBe('No pudimos procesar tu información, por favor inténtalo mas tarde');
      ...
      expect(Constants.MSG_ERROR_GENERAL).toBe('No pudimos procesar tu información, por favor inténtalo mas tarde');
    });
  ...
  describe('Constants Usage Patterns', () => {
    it('should be usable in error handling scenarios', () => {
      ...
      expect(errorMessage).toBe('No pudimos procesar tu información, por favor inténtalo mas tarde');
    });
...
describe('DiccionarioMensajes Tests', () => {
  describe('DiccionarioMensajes Object', () => {
    ...
    it('should have correct values', () => {
      ...
      expect(DiccionarioMensajes.msgErrorUsuarioGeneral).toBe('No pudimos procesar tu información, por favor inténtalo mas tarde');
  ...
  describe('DiccionarioMensajes Usage Patterns', () => {
    it('should be usable in error response scenarios', () => {
      ...
      expect(errorResponse.mensajeUsuario).toBe('No pudimos procesar tu información, por favor inténtalo mas tarde');
